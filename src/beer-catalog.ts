...
const CATALOG: BeerEntry[] = [
  ...
  { slug: "hertog-jan-grand", name: "Hertog Jan Grand Pilsener", brewery: "AB InBev Netherlands", style: "Dutch Pilsner", abv: 5.1, colors: { primary: "#1A3C0A", secondary: "#E8F0E0", text: "#D4A547" } },
  ...
  { slug: "castelain-chti", name: "Castelain Ch'ti Blonde", brewery: "Brasserie Castelain", style: "Bière de Garde", abv: 6.4, colors: { primary: "#D4A547", secondary: "#FFF8E8", text: "#1A0F00" } },
