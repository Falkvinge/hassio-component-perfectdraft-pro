...
const CATALOG: BeerEntry[] = [
  ...
  { slug: "leffe-amber", name: "Leffe Ambrée", brewery: "Abbaye de Leffe", style: "Belgian Amber", abv: 6.6, colors: { primary: "#B5651D", secondary: "#FFF0D6", text: "#1A0F00" } },
  ...
  { slug: "leffe-prestige", name: "Leffe Prestige 1240", brewery: "Abbaye de Leffe", style: "Belgian Strong Blonde", abv: 8.5, colors: { primary: "#1A3366", secondary: "#E0E8F5", text: "#C8922A" } },
  { slug: "leffe-0", name: "Leffe Blonde 0.0%", brewery: "Abbaye de Leffe", style: "Non-Alcoholic Blonde", abv: 0.0, colors: { primary: "#C8922A", secondary: "#FFF6E0", text: "#1A0F00" } },
  ...
  { slug: "saint-feuillien", name: "Saint-Feuillien Blonde", brewery: "Brasserie St-Feuillien", style: "Belgian Blonde", abv: 7.5, colors: { primary: "#C8922A", secondary: "#FFF6E0", text: "#1A0F00" } },
  { slug: "dupont", name: "Saison Dupont Dry Hop", brewery: "Brasserie Dupont", style: "Belgian Saison", abv: 6.5, colors: { primary: "#8B6914", secondary: "#FFF8E0", text: "#1A0F00" } },
  ...
  { slug: "stella-artois-0", name: "Stella Artois 0.0%", brewery: "Brouwerij Artois", style: "Non-Alcoholic Lager", abv: 0.0, colors: { primary: "#0E4C1E", secondary: "#F0F8E8", text: "#FFFFFF" } },
  ...
  { slug: "san-miguel", name: "San Miguel", brewery: "San Miguel", style: "Spanish Lager", abv: 5.4, colors: { primary: "#C8102E", secondary: "#FFF0F0", text: "#FFFFFF" } },
  ...
  { slug: "franziskaner-royal", name: "Franziskaner Royal", brewery: "Spaten-Franziskaner-Bräu", style: "Weissbier", abv: 6.0, colors: { primary: "#1A1A5C", secondary: "#E0E0F8", text: "#F5C242" } },
  ...
  { slug: "lowenbrau", name: "Löwenbräu", brewery: "Löwenbräu", style: "Munich Helles", abv: 5.2, colors: { primary: "#003DA5", secondary: "#E8F0FF", text: "#FFFFFF" } },
  { slug: "hasseroder", name: "Hasseröder Premium", brewery: "Hasseröder Brauerei", style: "German Pilsner", abv: 4.9, colors: { primary: "#006838", secondary: "#E0F5E8", text: "#FFFFFF" } },
  { slug: "diebels", name: "Diebels Alt", brewery: "Brauerei Diebels", style: "Altbier", abv: 4.9, colors: { primary: "#4A2810", secondary: "#F5E6D0", text: "#FFFFFF" } },
  { slug: "schneider", name: "Schneider Bayrisch Hell", brewery: "G. Schneider & Sohn", style: "Bavarian Helles", abv: 5.2, colors: { primary: "#006838", secondary: "#E8F5E0", text: "#FFFFFF" } },
  { slug: "haake-beck", name: "Haake-Beck", brewery: "Brauerei Beck & Co", style: "German Pilsner", abv: 4.9, colors: { primary: "#006838", secondary: "#E0F5E8", text: "#FFFFFF" } },
  { slug: "fruh-kolsch", name: "Früh Kölsch", brewery: "Cölner Hofbräu Früh", style: "Kölsch", abv: 4.8, colors: { primary: "#C8102E", secondary: "#FFF0F0", text: "#FFFFFF" } },
  ...
  { slug: "camden-eazy", name: "Camden Eazy", brewery: "Camden Town Brewery", style: "Session Pale", abv: 4.0, colors: { primary: "#F5C242", secondary: "#FFFCE5", text: "#000000" } },
  ...
  { slug: "vocation-hop-skip", name: "Vocation Hop, Skip & Juice", brewery: "Vocation Brewery", style: "Pale Ale", abv: 5.7, colors: { primary: "#F5A623", secondary: "#FFFAE5", text: "#1A1A1A" } },
  ...
  { slug: "ninkasi", name: "Ninkasi IPA", brewery: "Ninkasi Brasserie", style: "India Pale Ale", abv: 5.4, colors: { primary: "#D45500", secondary: "#FFF2E5", text: "#FFFFFF" } },
  ...
  { slug: "old-speckled-hen", name: "Old Speckled Hen", brewery: "Greene King", style: "English Bitter", abv: 5.0, colors: { primary: "#8B4513", secondary: "#FFF5EB", text: "#FFFFFF" } },
  { slug: "northern-monk", name: "Northern Monk A Little Faith", brewery: "Northern Monk", style: "Session Pale", abv: 4.0, colors: { primary: "#1A1A1A", secondary: "#F0F0F0", text: "#F5C242" } },
  { slug: "st-austell", name: "St Austell Proper Job IPA", brewery: "St Austell", style: "India Pale Ale", abv: 5.5, colors: { primary: "#C8102E", secondary: "#FFF0F0", text: "#FFFFFF" } },
  { slug: "trooper", name: "Trooper Original", brewery: "Robinsons", style: "English Bitter", abv: 4.7, colors: { primary: "#1A1A1A", secondary: "#F0F0F0", text: "#C8102E" } },

  // === FRENCH ===
  { slug: "castelain", name: "Castelain Grand Cru", brewery: "Brasserie Castelain", style: "Bière de Garde", abv: 6.2, colors: { primary: "#8B6914", secondary: "#FFF8E0", text: "#FFFFFF" } },
  ...
  { slug: "anoesteke", name: "Anosteké Blonde", brewery: "Brasserie du Pays Flamand", style: "French Blonde", abv: 8.0, colors: { primary: "#D4A547", secondary: "#FFF8E8", text: "#1A0F00" } },
  { slug: "rousse-mont-blanc", name: "Rousse du Mont Blanc", brewery: "Brasserie du Mont Blanc", style: "French Amber", abv: 6.5, colors: { primary: "#B5651D", secondary: "#FFF0D6", text: "#FFFFFF" } },
